...
function join(roomID) {
  ...
  socket.emit('join', firebase.auth().currentUser.uid, 'vonlutary', obj, function(socketIds){
...
const WaitingQueueVonlutary = React.createClass({
...
export default WaitingQueueVonlutary;